        ...
        if (GenerateCase.imgString != null || GenerateCase.imgString2 != null) {
            ...
            if (GenerateCase.imgString != null) {
                try {
                    ...
                    image_display1.setRotation(0);
                    // image_display1.setRotation(image_display1.getRotation() + 90);
            ...
            if (GenerateCase.imgString2 != null) {
                try {
                    ...
                    image_display2.setRotation(0);
                    // image_display2.setRotation(image_display2.getRotation() + 90);
